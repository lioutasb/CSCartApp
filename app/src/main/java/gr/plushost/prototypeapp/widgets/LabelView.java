...
public class LabelView extends TextView {
    ...
    private int _drawableRes = R.drawable.view_line_dotted;
    ...
    public LabelView(Context context, int drawableRes) {
        this(context, null, drawableRes);

    }

    public LabelView(Context context, AttributeSet attrs, int drawableRes) {
        this(context, attrs, android.R.attr.textViewStyle, drawableRes);
    }

    public LabelView(Context context, AttributeSet attrs, int defStyle, int drawableRes) {
        super(context, attrs, defStyle);

        _drawableRes = drawableRes;
    ...
    private void init() {
        ...
        //setBackground(ContextCompat.getDrawable(getContext(), R.drawable.view_line_dotted));
        setBackgroundResource(_drawableRes);
    }
