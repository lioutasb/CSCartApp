package gr.plushost.prototypeapp.quickreturn.listeners;
...
import gr.plushost.prototypeapp.quickreturn.utils.QuickReturnUtils;
...
public class QuickReturnListViewOnScrollListener implements AbsListView.OnScrollListener {
    ...
    // region Constructors
    public QuickReturnListViewOnScrollListener(Builder builder) {
        ...
        if(diff != 0){
            switch (mQuickReturnViewType){
                case HEADER:
                    ...
                    //Log.d(getClass().getSimpleName(), "onScroll() : mHeaderDiffTotal - "+mHeaderDiffTotal);
